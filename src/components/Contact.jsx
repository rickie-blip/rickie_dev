...
const Contact = () => (
  <div className="max-w-2xl mx-auto px-4 py-24">
    <div className="text-center mb-12">
      <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4 flex items-center justify-center gap-3 transition-colors duration-300">
    ...
    <div className="rounded-2xl border border-slate-200 dark:border-slate-700/80 bg-white/80 dark:bg-slate-800/30 backdrop-blur-sm overflow-hidden shadow-xl shadow-slate-200/30 dark:shadow-slate-950/30 transition-colors duration-300">
      <div className="p-6 sm:p-8 space-y-6">
        <a
          ...
          className="flex items-center p-5 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/50 hover:border-emerald-500/50 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all duration-300 group"
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-sm">contact@korirderrick.dev</p>
          </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <a
            ...
            className="flex items-center p-5 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/50 hover:border-blue-500/50 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all duration-300 group"
          >
