...
const Experience = () => (
  <div className="max-w-4xl mx-auto px-4 py-24">
    <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-12 flex items-center gap-3 transition-colors duration-300">
      <span className="w-8 h-1 bg-emerald-500 rounded-full" aria-hidden />
      Experience
    </h2>

    <div className="relative border-l-2 border-slate-300 dark:border-slate-800 ml-3 md:ml-6 space-y-12 transition-colors duration-300">
      <div className="relative pl-8 md:pl-12">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
          <h3 className="text-xl font-bold text-slate-900 dark:text-white transition-colors duration-300">Software Developer</h3>
        ...
        <div className="text-lg text-slate-600 dark:text-slate-300 font-medium mb-4 flex items-center gap-2 transition-colors duration-300">
          <Briefcase size={18} className="text-slate-500" aria-hidden />
          Shop Zetu
        </div>

        <div className="bg-white dark:bg-slate-800/30 p-6 rounded-xl border border-slate-200 dark:border-slate-800 hover:border-slate-300 dark:hover:border-slate-700 transition-all duration-300 shadow-sm dark:shadow-none">
