...
const Hero = ({ setActiveTab }) => (
  <section className="min-h-[calc(100vh-4rem)] flex items-center justify-center pt-14 sm:pt-16 pb-14 sm:pb-20 relative overflow-hidden">
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center z-10">
      ...
      <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-slate-900 dark:text-white mb-5 sm:mb-6 tracking-tight leading-tight transition-colors duration-300">
        Bridging Backend Logic, <br />
      ...
      <p className="text-base sm:text-lg md:text-xl text-slate-600 dark:text-slate-400 mb-8 sm:mb-10 max-w-2xl mx-auto leading-relaxed transition-colors duration-300">
        I bridge the gap between complex backend systems and seamless frontend experiences,
         delivering scalable, cloud-ready digital solutions.
          My expertise spans full-stack development, backend engineering, cloud architecture,
           API ecosystems, e-commerce platforms, automation, and secure high-performance applications
            built with modern backend technologies and advanced web frameworks.
      </p>
      ...
      <div className="mt-12 sm:mt-14 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 text-slate-500 dark:text-slate-500 transition-colors duration-300 max-w-3xl mx-auto">
        <div className="flex flex-col items-center gap-2 rounded-xl border border-slate-200 dark:border-slate-800 bg-white/70 dark:bg-slate-900/40 py-4 px-3">
