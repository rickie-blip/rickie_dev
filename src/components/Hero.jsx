...
const Hero = ({ setActiveTab }) => (
  <div className="min-h-screen flex items-center justify-center pt-16 relative overflow-hidden">
    ...
    <div className="max-w-4xl mx-auto px-4 text-center z-10">
      ...
      <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-slate-300/80 dark:border-slate-700/80 bg-white/70 dark:bg-slate-900/60 backdrop-blur-sm text-left mb-8 w-full max-w-md mx-auto font-mono text-sm shadow-sm dark:shadow-none transition-colors duration-300">
      ...
      <h1 className="text-5xl md:text-7xl font-bold text-slate-900 dark:text-white mb-6 tracking-tight transition-colors duration-300">
        Building Secure, <br />
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        <button
          ...
          className="px-8 py-3 rounded-lg bg-emerald-500 hover:bg-emerald-600 text-white font-semibold transition-all shadow-lg shadow-emerald-500/25 dark:shadow-emerald-500/20 flex items-center justify-center gap-2 hover:shadow-emerald-500/40 dark:hover:shadow-emerald-500/30"
        >
          View My Work <ChevronRight size={18} />
        </button>
        <button
          onClick={() => setActiveTab('contact')}
          className="px-8 py-3 rounded-lg border border-slate-300 dark:border-slate-700 hover:border-slate-400 dark:hover:border-slate-500 text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white font-semibold transition-all bg-white/60 dark:bg-slate-800/50 hover:bg-slate-100 dark:hover:bg-slate-800/70 shadow-sm"
        >
          Contact Me
        </button>
      </div>

      <div className="mt-16 flex flex-wrap justify-center gap-8 text-slate-500 dark:text-slate-500 transition-colors duration-300">
